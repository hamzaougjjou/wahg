...
use App\Http\Controllers\Dashboard\StudentController as AdminStudentController;
use App\Http\Controllers\Dashboard\TeacherController as AdminTeacherController;
use App\Http\Controllers\Dashboard\SubscriptionController as AdminSubscriptionController;
...
// Route::middleware(['auth:api', 'admin'])->group(function () { // DONT CHANGE ANYTHING ABOU ADMIN MIDDLEWASE PLS
Route::middleware(['auth:api'])->group(function () {
     ...
     Route::get('admin/students', [AdminStudentController::class, 'index']);
     Route::put('admin/students/{student_id}/status', [AdminStudentController::class, 'updateStudentStatus']);
...
Route::middleware('auth:api')->group(function () {
   ...
   Route::get('getand-search-favorites',[FavoriteController::class,'get_Search_Favorites']);
});
...
Route::group(['middleware' => ['auth:api']], function () {
    Route::get('/home/levels', [HomeController::class, 'get_courses_level']);
    Route::get('/home/courses-by-level/{level}', [HomeController::class, 'courses_by_level']);
});
